...
SWIFT_CLASS("_TtC10CirrentSDK21CustomSessionDelegate")
@interface CustomSessionDelegate : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface CustomSessionDelegate (SWIFT_EXTENSION(CirrentSDK)) <NSURLSessionDelegate>
...
@interface CustomSessionDelegate (SWIFT_EXTENSION(CirrentSDK)) <NSURLSessionDataDelegate>
...
@interface CustomSessionDelegate (SWIFT_EXTENSION(CirrentSDK)) <NSURLSessionDownloadDelegate>
...
@interface CustomSessionDelegate (SWIFT_EXTENSION(CirrentSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC10CirrentSDK10DeviceInfo")
@interface DeviceInfo : CustomEVObject
...
@property (nonatomic, copy) NSString * _Nonnull customString;
@property (nonatomic, readonly, copy) NSString * _Nonnull debugDescription;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10CirrentSDK16NetworkEventData")
@interface NetworkEventData : BaseData
@end
...
SWIFT_CLASS("_TtC10CirrentSDK16WifiNetworkArray")
@interface WifiNetworkArray : CustomEVObject
@property (nonatomic, copy) NSArray<WiFiNetwork *> * _Nonnull value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
